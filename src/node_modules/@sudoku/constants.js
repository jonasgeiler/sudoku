export const BASE_URL = 'https://sudoku.skayo.dev/';

export const DIFFICULTIES = { veryeasy: 'Very Easy', easy: 'Easy', medium: 'Medium', hard: 'Hard' };
export const DEFAULT_SETTINGS = { darkTheme: false, displayTimer: true, highlightCells: true, highlightMatching: true, highlightConflicting: true };
