...
export function validateSencode(sencode) {
	...
	if(sencode.indexOf("bd=") != -1){
		let p = sencode.split("bd=")[1]
	}
	else{
		let p = sencode
	}
	// type 1
	if(validateLength(sencode) && isNumeric(sencode))   return true
	// type 2
	if(validateLength(sencode) && isNumDot(sencode))   return true
	// type 3
